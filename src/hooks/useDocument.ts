...
import type { IPhotographer } from "../enums/types";
...
export function useDocument() {
  ...
  const insertDocument = useCallback(async (collectionName: string, documentData: IPhotographer) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const updateDocument = useCallback(async (collectionName: string, id: string, data: Partial<IPhotographer>) => {
    setLoading(true);
    setError(null);
    try {
